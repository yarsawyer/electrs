...
impl Updater {
    pub(crate) fn update(
        ...
        store: Arc<Store>,
        mut outpoint_sender: &mut UnboundedSender<OutPoint>,
        mut value_receiver: &mut UnboundedReceiver<u64>,
        ...
        updater.index_block(
            ...
            &mut outpoint_sender,
            &mut value_receiver,
            BlockData::from(block_data.block.clone()),
            &mut value_cache,
        )
    }
    ...
    fn index_block(
        &mut self,
        store: Arc<Store>,
        outpoint_sender: &mut UnboundedSender<OutPoint>,
        value_receiver: &mut UnboundedReceiver<u64>,
        block: BlockData,
        ...
        //             inscription_updater.W(tx, *txid, None)?;
